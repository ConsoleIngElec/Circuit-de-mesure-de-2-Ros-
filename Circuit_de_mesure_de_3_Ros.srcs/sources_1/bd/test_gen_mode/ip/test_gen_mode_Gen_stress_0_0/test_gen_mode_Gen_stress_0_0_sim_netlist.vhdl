...
--               c:/Users/cmbouba/Mes_projets_pour_le_stage/Circuit_de_mesure_de_3_Ros/Circuit_de_mesure_de_3_Ros.srcs/sources_1/bd/test_gen_mode/ip/test_gen_mode_Gen_stress_0_0/test_gen_mode_Gen_stress_0_0_sim_netlist.vhdl
...
entity test_gen_mode_Gen_stress_0_0_Clock_Diviser is
  port (
  ...
  attribute ORIG_REF_NAME of test_gen_mode_Gen_stress_0_0_Clock_Diviser : entity is "Clock_Diviser";
end test_gen_mode_Gen_stress_0_0_Clock_Diviser;

architecture STRUCTURE of test_gen_mode_Gen_stress_0_0_Clock_Diviser is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity test_gen_mode_Gen_stress_0_0_Stress_100Hz is
  port (
    Stress : out STD_LOGIC_VECTOR ( 0 to 0 );
    Clk : in STD_LOGIC;
    Reset : in STD_LOGIC
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of test_gen_mode_Gen_stress_0_0_Stress_100Hz : entity is "Stress_100Hz";
end test_gen_mode_Gen_stress_0_0_Stress_100Hz;

architecture STRUCTURE of test_gen_mode_Gen_stress_0_0_Stress_100Hz is
begin
I_Clock_Diviser: entity work.test_gen_mode_Gen_stress_0_0_Clock_Diviser
     port map (
      Clk => Clk,
      Reset => Reset,
      Stress(0) => Stress(0)
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity test_gen_mode_Gen_stress_0_0_Gen_stress is
  port (
    Stress : out STD_LOGIC_VECTOR ( 0 to 0 );
    Clk : in STD_LOGIC;
    Reset : in STD_LOGIC
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of test_gen_mode_Gen_stress_0_0_Gen_stress : entity is "Gen_stress";
end test_gen_mode_Gen_stress_0_0_Gen_stress;

architecture STRUCTURE of test_gen_mode_Gen_stress_0_0_Gen_stress is
begin
I_Stress_100Hz: entity work.test_gen_mode_Gen_stress_0_0_Stress_100Hz
     port map (
      Clk => Clk,
      Reset => Reset,
      Stress(0) => Stress(0)
...
entity test_gen_mode_Gen_stress_0_0 is
  ...
  attribute NotValidForBitStream of test_gen_mode_Gen_stress_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of test_gen_mode_Gen_stress_0_0 : entity is "test_gen_mode_Gen_stress_0_0,Gen_stress,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of test_gen_mode_Gen_stress_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of test_gen_mode_Gen_stress_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of test_gen_mode_Gen_stress_0_0 : entity is "Gen_stress,Vivado 2018.3";
end test_gen_mode_Gen_stress_0_0;

architecture STRUCTURE of test_gen_mode_Gen_stress_0_0 is
  ...
  attribute x_interface_parameter of Clk : signal is "XIL_INTERFACENAME Clk, ASSOCIATED_RESET Reset, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN test_gen_mode_zynq_ultra_ps_e_0_1_pl_clk0, INSERT_VIP 0";
...
U0: entity work.test_gen_mode_Gen_stress_0_0_Gen_stress
     port map (
      Clk => \^clk\,
      Reset => Reset,
      Stress(0) => \^stress\(2)
