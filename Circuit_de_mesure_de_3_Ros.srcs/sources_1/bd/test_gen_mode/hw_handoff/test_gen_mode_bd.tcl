...
################################################################
# This is a generated script based on design: test_gen_mode
#
...
# source test_gen_mode_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# All_Ro_out, Gen_mode, Gen_stress
...
proc create_root_design { parentCell } {
  ...
  set block_cell_name All_Ro_out_0
  if { [catch {set All_Ro_out_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  # Create instance: Gen_stress_0, and set properties
  set block_name Gen_stress
  set block_cell_name Gen_stress_0
  if { [catch {set Gen_stress_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $Gen_stress_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net All_Ro_out_0_Data [get_bd_pins All_Ro_out_0/Data] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_2/Din] [get_bd_pins xlslice_3/Din]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xA0002000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_2/S_AXI/Reg] SEG_axi_gpio_2_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0xA0003000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_3/S_AXI/Reg] SEG_axi_gpio_3_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0xA0004000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_4/S_AXI/Reg] SEG_axi_gpio_4_Reg
