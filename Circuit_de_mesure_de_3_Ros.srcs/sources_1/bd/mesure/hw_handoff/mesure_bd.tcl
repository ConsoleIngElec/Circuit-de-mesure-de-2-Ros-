...
################################################################
# This is a generated script based on design: mesure
#
...
proc create_hier_cell_Sysmon { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net Reset_1 [get_bd_pins Reset] [get_bd_pins system_management_wiz_0/reset_in]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins IP_Conversion_Axi_0/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs IP_Conversion_Axi_0/S00_AXI/S00_AXI_reg] SEG_IP_Conversion_Axi_0_S00_AXI_reg
